      ...
      <section className="relative w-full bg-gradient-to-br from-primary via-primary to-secondary overflow-hidden">
        ...
        <div className="relative w-full aspect-[16/7] md:aspect-[16/5] lg:aspect-[16/4] flex items-center justify-center">
          <div className="text-center text-white px-4 max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-medium mb-6 opacity-0 animate-[scale-in_0.5s_ease-out_forwards]">
              <Sparkles className="h-4 w-4" />
              <span>وكيل معتمد للماركات العالمية</span>
            </div>
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-6 opacity-0 animate-[slide-up_0.8s_ease-out_0.1s_forwards]">
              مع <span className="text-secondary-foreground bg-secondary/30 px-3 py-1 rounded-lg">دريم</span> للتجارة والتوريدات
            </h1>
            <p className="text-lg md:text-xl lg:text-2xl opacity-90 mb-8 opacity-0 animate-[slide-up_0.8s_ease-out_0.2s_forwards]">
              أفضل الأسعار • ضمان 5 سنوات • توصيل وتركيب مجاني
            </p>
            <div className="flex flex-wrap gap-4 justify-center opacity-0 animate-[slide-up_0.8s_ease-out_0.3s_forwards]">
              <Link to="/products">
